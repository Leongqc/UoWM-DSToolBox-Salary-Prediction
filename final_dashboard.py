...
# Exploratory Data Analysis (EDA) section
    ...
    # Chapter 1
    st.title("Chapter 1: Discovering the Top Earners")
    ...
    # Chapter 2
    st.title("Chapter 2: The Impact of Age on Earnings")
    ...
    # Chapter 3
    st.title("Chapter 3: Gender Dynamics in Career Experience")
    ...
    # Chapter 4
    st.title("Chapter 4: The Role of Education")
    ...
    # Chapter 5
    st.title("Chapter 5: Industry Insights")
